        ...
        <footer className='flex justify-center flex-col  text-center bg-gray-100 py-6'>
          <div className="flex flex-col md:justify-between md:flex-row items-center py-8 md:px-32">
            <div className="flex flex-col md:items-start">
              ...
              <a href="/terms" target="_blank" rel="noreferrer" className="my-1">Terms and Conditions</a>
              <a href="/privacy" target="_blank" rel="noreferrer">Privacy policy</a>
            </div>

            <div className="flex flex-col my-8 md:my-0 md:items-start">
              <b className="mb-3 text-lg">Support</b>
              <a href="/contact-us" target="_blank" rel="noreferrer">Contact</a>
              <a href="https://discord.gg/" target="_blank" rel="noreferrer" className="my-1">Discord</a>
            </div>

            <div>
              <b className='mt-4'>Connect with us:</b>
              <div className='flex justify-center my-2'>
                  <a href='https://www.linkedin.com/' target="_blank" rel="noreferrer" className='border-2 border-gray-200 rounded-full p-3 mx-1 hover:bg-green-600 hover:text-white'>
                      <FaLinkedinIn />
                  </a>
                  <a href='https://www.instagram.com/' target="_blank" rel="noreferrer" className='border-2 border-gray-200 rounded-full p-3 mx-1 hover:bg-green-600 hover:text-white'>
                      <FaInstagram />
                  </a>
                  <a href='https://twitter.com/' target="_blank" rel="noreferrer" className='border-2 border-gray-200 rounded-full p-3 mx-1 hover:bg-green-600 hover:text-white'>
                      <FaTwitter />
                  </a>
              </div>
            </div>
